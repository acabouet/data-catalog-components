...
exports.useSimpleSearch = useSimpleSearch;
...
function useSimpleSearch(url, defaultFacets) {
  ...
  _react["default"].useEffect(function () {
    ...
    var newSearchEngine = new _search["default"]['simpleSearch']();
...
function useLunrSearch(url, defaultFacets) {
  var _React$useState3 = _react["default"].useState(),
      ...
      searchEngine = _React$useState4[0],
      setSearchEngine = _React$useState4[1];
  ...
  _react["default"].useEffect(function () {
    ...
    function fetchSearchIndex() {
      return _fetchSearchIndex2.apply(this, arguments);
    }

    function _fetchSearchIndex2() {
      _fetchSearchIndex2 = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    function initSearchEngine() {
      return _initSearchEngine2.apply(this, arguments);
    }

    function _initSearchEngine2() {
      _initSearchEngine2 = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
...
function useSearchData(searchEngine, searchPage, searchQuery, searchSort, searchPageSize, selectedFacets) {
  ...
  var _React$useState7 = _react["default"].useState(0),
      ...
      totalResults = _React$useState8[0],
      setTotalResults = _React$useState8[1];

  var _React$useState9 = _react["default"].useState({}),
      _React$useState10 = (0, _slicedToArray2["default"])(_React$useState9, 2),
      facetResults = _React$useState10[0],
      setFacetResults = _React$useState10[1];

  var _React$useState11 = _react["default"].useState([]),
      _React$useState12 = (0, _slicedToArray2["default"])(_React$useState11, 2),
      items = _React$useState12[0],
      setItems = _React$useState12[1];
...
function useUrlParams(searchUrl, defaultFacets, searchPage, searchQuery, searchSort, searchPageSize, selectedFacets) {
  var _React$useState13 = _react["default"].useState({}),
      ...
      newParams = _React$useState14[0],
      setNewParams = _React$useState14[1];
...
function useFilteredFacets(facetKey, selectedFacets, facetResults) {
  var _React$useState15 = _react["default"].useState([]),
      ...
      returnedFacets = _React$useState16[0],
      setReturnedFacets = _React$useState16[1];
