...
var Resource = function Resource(_ref) {
  ...
  var datasetURL = (0, _useDatasetUrl["default"])(data.data);
  ...
  var type = data.data && data.data.mediaType ? data.data.mediaType.split("/") : '';
  var backup = type ? type[1] : '';
  var format = data.data && data.data.format ? data.data.format : backup;
  ...
  })) : _react["default"].createElement("div", null, data.data && _react["default"].createElement(_FileDownload["default"], {
    format: format,
    downloadURL: datasetURL,
