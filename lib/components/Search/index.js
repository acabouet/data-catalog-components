...
var Search = function Search(_ref) {
  ...
  var _useReducer = (0, _react.useReducer)(_search_reducer["default"], _objectSpread({}, _search_defaults.defaultSearchState, {}, initialSearchState, {}, _queryString["default"].parse(location.search))),
  ...
  (0, _react.useEffect)(function () {
    ...
    function _getSearchData() {
      ...
      _regenerator["default"].mark(function _callee() {
        var currentSort, searchParams, facetKeys, params, searchUrl, results;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                currentSort = findSortParams(); // set search params using sort and searchState
                ...
                if (setSearchUrl) {
                  searchUrl = "".concat(path, "?").concat(params);
                ...
                _context.next = 8;
                return _axios["default"].get("".concat(searchEndpoint, "?").concat(params));
    ...
    getSearchData();
  }, [sortOptions, defaultFacets, path, setSearchUrl, searchEndpoint, searchState.sort, searchState.fulltext, searchState.pageSize, searchState.page, searchState.selectedFacets, normalize]);
