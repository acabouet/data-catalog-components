            ...
            <Branding>
              ...
              <div className="social">
                <a href="https://www.facebook.com/GetDKAN/">
                  <i className="fa fa-facebook" aria-hidden="true" role="presentation"/>
                  <span className="sr-only">Facebook</span>
                </a>
                <a href="https://twitter.com/getdkan">
                  <i className="fa fa-twitter" aria-hidden="true" role="presentation"/>
                  <span className="sr-only">Twitter</span>
                </a>
                <a href="https://dkan.slack.com/">
                  <i className="fa fa-slack" aria-hidden="true" role="presentation"/>
                  <span className="sr-only">Slack</span>
                </a>
                <a href="https://github.com/getdkan">
                  <i className="fa fa-github" aria-hidden="true" role="presentation"/>
